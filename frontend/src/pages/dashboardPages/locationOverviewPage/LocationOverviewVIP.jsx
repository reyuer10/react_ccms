...
function LocationOverviewVIP() {
  ...
  const tableImages = [
    { src: Tableimg1, text: 'VIP1' },
    { src: Tableimg2, text: 'VIP2' },
    { src: Tableimg3, text: 'VIP3' },
    { src: Tableimg4, text: 'VIP4' },
    { src: Tableimg5, text: 'VIP5' },
    { src: Tableimg6, text: 'VIP6' },
    { src: Tableimg7, text: 'VIP7' },
    { src: Tableimg8, text: 'VIP8' },
    { src: Tableimg9, text: 'VIP9' },
  ];
...
export default LocationOverviewVIP;
