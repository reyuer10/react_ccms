...
function LocationOverviewHL() {
  ...
  const tableImages = [
    { src: Tableimg1, text: 'HL1' },
    { src: Tableimg2, text: 'HL2' },
    { src: Tableimg3, text: 'HL3' },
    { src: Tableimg4, text: 'HL4' },
    { src: Tableimg5, text: 'HL5' },
    { src: Tableimg6, text: 'HL6' },
    { src: Tableimg7, text: 'HL7' },
    { src: Tableimg8, text: 'HL8' },
    { src: Tableimg9, text: 'HL9' },
  ];
...
export default LocationOverviewHL;
