...
function CanisterHeader({
  handleOpenPage,
  canisterSearchInput,
  setCanisterSearchInput,
}) {
  return (
    <div className="flex justify-between items-center">
      <InputHeader
        value={canisterSearchInput}
        onChange={(e) => setCanisterSearchInput(e.target.value)}
        placeholderLabel="canister code"
        name="canisterSearchInput"
      />
      <div>
        <button
